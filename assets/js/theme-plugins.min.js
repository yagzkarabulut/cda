...
!(function (s, t, a, r) {
  ...
  function l(t, e, n) {
    ...
    (i.obj = t),
      ...
      e &&
        ...
        ((e.sortByDimension = e.sortToPreventGaps), delete e.sortToPreventGaps),
      (i.options = s.extend(
        {},
    ...
    wrapInner: function (t, e) {
      ...
      if (((e = e || ""), !(t.length && t.length < 1)))
        for (t.length === r && (t = [t]), i = t.length - 1; 0 <= i; i--) {
          for (
            n = t[i], (o = a.createElement("div")).setAttribute("class", e);
            n.childNodes.length;
        ...
        0 !== i
          ? s.each(t, function (t, e) {
              ...
              n.on("load.cbp error.cbp", function () {
                ...
                e.srcset
                  ? (n.attr("sizes", e.sizes), n.attr("srcset", e.srcset))
                  : n.attr("src", e.src);
            })
          : o.call(a);
      });
          ...
          e.filters.each(function (t, e) {
            ...
            i.removeClass("cbp-filter-item-active"),
              c.each(o, function (t, e) {
                ...
                if (n.length)
                  return (
                    n.addClass("cbp-filter-item-active"), o.splice(t, 1), !1
                  );
              });
          }),
  ...
  (function (o, t, e, n) {
      ...
      i.registerEvent("onMediaQueries", function (t) {
        (i.options.gapVertical =
          ...
          (i.options.gapHorizontal =
            t && t.hasOwnProperty("gapHorizontal") ? t.gapHorizontal : n),
    ...
    o.fn.cubeportfolio.constructor.plugins.changeGapOnMediaQueries = function (
      t
    ) {
      return new i(t);
    };
    ...
    var l = u.fn.cubeportfolio.constructor,
      ...
      e = {
        ...
        createMarkup: function () {
          ...
          if (
            ("singlePage" === r.type &&
              ...
              (t = " cbp-popup-singlePage-" + r.options.singlePageAnimation),
            (r.wrap = u("<div/>", {
            ...
            var i =
              "onwheel" in f.createElement("div") ? "wheel" : "mousewheel";
        ...
        createMarkupSinglePageInline: function () {
          var n = this;
          (n.wrap = u("<div/>", { class: "cbp-popup-singlePageInline" }).on(
            "click.cbp",
            function (t) {
              if (!n.stopEvents) {
                var e = u(t.target).attr("data-action");
            ...
            (n.content = u("<div/>", { class: "cbp-popup-content" }).appendTo(
              n.wrap
            )),
            (n.navigation = u("<div/>", {
              class: "cbp-popup-navigation",
        ...
        openSinglePageInline: function (t, e, n) {
          ...
          if (
            ...
            return (
              ...
              void (r.dataArray[r.current].url !== e.getAttribute("href") ||
              r.current !== o
            ...
            (r.top = s),
              t.each(function (t, e) {
                var n = u(e).data("cbp"),
                  ...
                  o = i + n.heightAndGap;
                s <= i ||
                  (o > r.top && ((r.top = o), (r.topDifference = r.top - s)));
              }),
              (r.blocksToMove = u()),
              t.each(function (t, e) {
                if (t !== r.current) {
                ...
                e.readyState
                  ? (e.onreadystatechange = function () {
                      ("loaded" != e.readyState &&
                        ...
                        ((e.onreadystatechange = null), i[++a] && r(i[a]));
                    })
                  : (e.onload = function () {
                      i[++a] && r(i[a]);
                    }),
          ...
          (e.current = e.getIndex(e.current + t)),
            u.isFunction(e.options.singlePageCallback) &&
              ...
              e.options.singlePageDeeplinking &&
                (location.href = e.url + "#cbp=" + e.dataArray[e.current].url));
        },
        resetWrap: function () {
          var t = this;
          "singlePage" === t.type &&
              ...
              ? o.blocksOn.each(function (t, e) {
                  ...
                  n.not(".cbp-item-off") &&
                    n.find(s.options.lightboxDelegate).each(function (t, e) {
                      i
                        ? u(e).attr("data-cbp-lightbox") === i && a.push(e)
                        : a.push(e);
                    });
                })
              : (a = i
              ...
              ? o.blocksOn.each(function (t, e) {
                  ...
                  n.not(".cbp-item-off") &&
                    n.find(s.options.singlePageDelegate).each(function (t, e) {
                      i
                        ? u(e).attr("data-cbp-singlePage") === i && a.push(e)
                        : a.push(e);
                    });
                })
              : (a = i
        ...
        s.options.singlePageInlineDelegate &&
          ...
          s.$obj.on(
            ...
            function (t) {
              ...
              (!e || 300 < n - e) &&
                s.singlePageInline.openSinglePageInline(s.blocksOn, this);
            }
          ));
    }),
  ...
  (function (u, t, e, n) {
    ...
    (a.prototype.processSort = function () {
      ...
      var i = o.sortBy.split(":"),
        ...
        r = 1;
      if (
        ("int" === i[0] ? (a = "int") : "float" === i[0] && (a = "float"),
        "desc" === i[1] && (r = -1),
        o.sort)
      ) {
        var s = [];
        t.blocks.each(function (t, e) {
          ...
          s.sort(function (t, e) {
            var n = t.sortText,
              i = e.sortText;
            return (
              "string" === a && ((n = n.toUpperCase()), (i = i.toUpperCase())),
              n < i ? -r : i < n ? r : 0
            );
          }),
